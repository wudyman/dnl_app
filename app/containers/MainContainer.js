...
class MainContainer extends React.Component {
  ...
  static navigationOptions = ({ navigation }) => {
    return{
      ...
      headerRight: (<Button text='提问' onPress={()=>navigation.navigate('Misc',{pageType:'ask',isSignIn:isSignIn})} btnStyle={{padding:15}} textStyle={{fontSize:16,fontWeight:'100',textAlign: 'center',color:'#565'}}/>),
      headerTitle:(
